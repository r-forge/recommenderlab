...
recommender_registry <- registry(registry_class="recommender_registry", 
    entry_class="recommender_method")

recommender_registry$set_field("method", type = "character", 
    is_key = TRUE, index_FUN = match_partial_ignorecase)
recommender_registry$set_field("fun", type = "function", 
    is_key = FALSE)
recommender_registry$set_field("description", type = "character", 
    is_key = FALSE)
